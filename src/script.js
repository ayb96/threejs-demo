...
const tick = () => {
  ...
  museumMap.position.z += (-80 * targetY - museumMap.position.z) / 10;
  cube.position.z += (-80 * targetY - museumMap.position.z) / 10;
  cube1.position.z += (-80 * targetY - museumMap.position.z) / 10;
  cube2.position.z += (-80 * targetY - museumMap.position.z) / 10;
